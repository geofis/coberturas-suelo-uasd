...
- [Hexágonos clasificados según cobertura](fuentes/h3-res-12-no-edificios-clasificado.gpkg). Este archivo contiene los hexágonos clasificados según su cobertura predominante. Fue realizado usando el *script* [clasificacion-de-hexagonos.gpkg](clasificacion-de-hexagonos.Rmd) 
